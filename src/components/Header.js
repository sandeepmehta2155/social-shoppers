...
const Header = (props) => {
  ...
  const handleChange = (event) => {
    if (event.target.value.length === 0) {
      ...
      axios
        .get(`wallmart/?search=${event.target.value}&page=1&limit=15`)
        .then((resp) => {
      ...
      <div className="container">
        <nav className="navbar navbar-default navbar-expand-lg bg-transparent">
          ...
          <div className="search-area">
            ...
            {searchList.length && showResults > 0 ? (
              <div id="keyword-searcher">
                <div className="cart-products-block">
                    ...
                    searchList.map((item, index) => (
                      <div className="cart-product" key={index}>
                        <a href={item.Url} target="_blank">
                          ...
                          <span>
                            {item.Name}
                            <br /> price:{item.CurrentPrice} {item.Currency}
                          </span>
                        </a>
                  ...
                  <div className="d-flex">
                    <button
                      onClick={() => navigate("/productresults/" + query)}
